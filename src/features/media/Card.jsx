...
// قم بإلغاء التعليق عن السطر التالي وتأكد من المسار بعد إنشاء ملف الـ Context
...
export default function Card({ item, type }) {
  ...
  // // Derived State: استنتاج الحالة من خلال التحقق من وجود العنصر في المصفوفة
  // const isInWish = wishList?.some((wishItem) => wishItem.id === item.id);
  
  // const handleAddToWishList = (e) => {
  //   e.stopPropagation(); // لمنع تفعيل الـ navigate للـ details
  //   addToWishList(item); 
  // };
  ...
  const handleAddToWishList = (e) => e.stopPropagation();
  const handleRemoveFromWishList = (e) => e.stopPropagation();
